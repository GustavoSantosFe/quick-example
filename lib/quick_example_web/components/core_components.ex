defmodule QuickExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(QuickExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(QuickExampleWeb.Gettext, "errors", msg, opts)
    end
  end
